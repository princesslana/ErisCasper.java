...
/**
 * @see <a
 *     href="https://discordapp.com/developers/docs/resources/user#get-current-user-guilds-query-string-params">
 *     https://discordapp.com/developers/docs/resources/user#get-current-user-guilds-query-string-params</a>
 */
@Value.Immutable
public interface GetUserGuildsRequest {
